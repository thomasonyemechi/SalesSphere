                    ...
                    <li class="nav-item bg-info mb-3 " style="color: white !important">
                        ...
                        <div id="navAuthentication" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column text-white">
                                <li class="nav-item">
                                    <a class="nav-link text-white " href="/admin/stock/3">Stock Profiler</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item mb-3 bg-info ">
                        ...
                        <div id="users_man" class="collapse " data-bs-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link text-white " href="/admin/add_staff">Add Employee</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link text-white" href="/admin/staffs">Employee list</a>
                                </li>
